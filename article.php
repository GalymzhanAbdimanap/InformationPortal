...
<div class="container">
	...
	<li><a href="vhod.php">Регистрация</a></li>
	<hr>
	...
	<div class = "content">
		...
		<?php
		$query_articles = mysql_query("SELECT * FROM articles");
		?>
		<?php while($row_articles = mysql_fetch_assoc($query_articles)):?>
		<?php 
		$query_comments = mysql_query("SELECT * FROM comments WHERE id_articles = '".$row_articles['id']."'");
		$row_comments = mysql_num_rows($query_comments);
		?>
		<div class="toplist">
			<h2><a href="article_2.php?id_articles=<?=$row_articles['id'];?>"><?=$row_articles['title'];?></a></h2>
			...
			<p><?=$row_articles['desk'];?><br><br><a href="article_2.php?id_articles=<?=$row_articles['id'];?>">Далее→</a></p>
